...
DATA_PX_UPDATE_SEC = _CONFIG_DATA_PX_UPDATE["complete-interval-sec"]
DATA_PX_UPDATE_CALC_SEC = _CONFIG_DATA_PX_UPDATE["complete-calc-sec"]
DATA_PX_UPDATE_BATCH_SEC = _CONFIG_DATA_PX_UPDATE["complete-batch-sec"]
DATA_PX_UPDATE_MARKET_SEC = _CONFIG_DATA_PX_UPDATE["market-interval-sec"]

_CONFIG_DATA_PX_REFETCH = _CONFIG_DATA_STREAM["px-history-refetch"]
DATA_PX_REFETCH_INTERVAL_SEC = _CONFIG_DATA_PX_REFETCH["interval-sec"]
DATA_PX_REFETCH_BACKWARD_MIN = _CONFIG_DATA_PX_REFETCH["backward-min"]
